...
use App\Models\Admin\PageEventModel;

class PageEvent extends AdminBaseController
{
    protected $_Model;
    ...
    public function __construct()
    {
		...
		$this->index_url = "admin/pageevent";
		$this->add_url = "admin/pageevent/add";
		$this->edit_url = "admin/pageevent/edit";
        helper(['form', 'url']);
