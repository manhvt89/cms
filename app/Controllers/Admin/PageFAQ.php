...
use App\Models\Admin\PageFAQModel;

class PageFAQ extends AdminBaseController
{
    protected $_Model;
    ...
    {
        $this->_Model = new PageFAQModel();
        $this->commonModel = new CommonModel();
		$this->index_url = "admin/pagefaq";
		$this->add_url = "admin/pagefaq/add";
		$this->edit_url = "admin/pagefaq/edit";
        helper(['form', 'url']);
	...
	public function edit($id)
	{
		...
		if($this->request->getPost('form1') ==1) 
		{
			...
			$faq_heading = $this->request->getPost('faq_heading');
			$mt_faq = $this->request->getPost('mt_faq');
			$mk_faq = $this->request->getPost('mk_faq');
			$md_faq = $this->request->getPost('md_faq');
			...
			$data['page_faq'] = $this->_Model->getData($id);
