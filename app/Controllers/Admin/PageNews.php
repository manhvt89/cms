...
use App\Models\Admin\PageNewsModel;

class PageNews extends AdminBaseController
{
    protected $_Model;
    ...
    {
        $this->_Model = new PageNewsModel();
        $this->commonModel = new CommonModel();
		$this->index_url = "admin/pagenews";
		$this->add_url = "admin/pagenews/add";
		$this->edit_url = "admin/pagenews/edit";
        helper(['form', 'url']);
