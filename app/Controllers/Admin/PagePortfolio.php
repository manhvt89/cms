...
use App\Models\Admin\PagePortfolioModel;

class PagePortfolio extends AdminBaseController
{
    protected $_Model;
    ...
    public function __construct()
    {
		...
		$this->index_url = "admin/pageportfolio";
		$this->add_url = "admin/pageportfolio/add";
		$this->edit_url = "admin/pageportfolio/edit";
        helper(['form', 'url']);
    ...
    public function index()
	{
		...
		$data = $this->data;
		$data['page'] = $_items;
		$data['title'] = "View Portfolio Page";
		//var_dump($_items);die();
