...
use App\Models\Admin\PageSearchModel;

class PageSearch extends AdminBaseController
{
    protected $_Model;
    ...
    public function __construct()
    {
		...
		$this->index_url = "admin/pagesearch";
		$this->add_url = "admin/pagesearch/add";
		$this->edit_url = "admin/pagesearch/edit";
        helper(['form', 'url']);
