...
use App\Models\Admin\PageServiceModel;

class PageService extends AdminBaseController
{
    protected $_Model;
    ...
    public function __construct()
    {
		...
		$this->index_url = "admin/pageservice";
		$this->add_url = "admin/pageservice/add";
		$this->edit_url = "admin/pageservice/edit";
        helper(['form', 'url']);
