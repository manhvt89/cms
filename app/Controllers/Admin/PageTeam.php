...
use App\Models\Admin\PageTeamModel;

class PageTeam extends AdminBaseController
{
    protected $_Model;
    ...
    public function __construct()
    {
		...
		$this->index_url = "admin/pageteam";
		$this->add_url = "admin/pageteam/add";
		$this->edit_url = "admin/pageteam/edit";
        helper(['form', 'url']);
