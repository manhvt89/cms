...
use App\Models\Admin\PageTermModel;

class PageTerm extends AdminBaseController
{
    protected $_Model;
    ...
    public function __construct()
    {
		...
		$this->index_url = "admin/pageterm";
		$this->add_url = "admin/pageterm/add";
		$this->edit_url = "admin/pageterm/edit";
        helper(['form', 'url']);
