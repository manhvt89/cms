...
class ModelDashboard extends Model
{
	...
	{
		$builder = $this->db->table('tbl_category');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_news()
	{
		$builder = $this->db->table('tbl_news');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_team_member()
    {
        $builder = $this->db->table('tbl_team_member');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_client()
    {
        $builder = $this->db->table('tbl_client');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_service()
    {
        $builder = $this->db->table('tbl_service');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_testimonial()
    {
        $builder = $this->db->table('tbl_testimonial');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_event()
    {
        $builder = $this->db->table('tbl_event');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_photo()
    {
        $builder = $this->db->table('tbl_photo');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
    public function show_total_pricing_table()
    {
        $builder = $this->db->table('tbl_pricing_table');  // Truy cập bảng tbl_category
        return $builder->countAll();  // Đếm số dòng trong bảng
    }
}
