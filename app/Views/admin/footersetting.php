                        ...
                        <tbody>
                            ...
                            foreach ($footer_setting as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(); ?>admin/footersetting/edit/<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Edit</a>
                                    </td>
                                </tr>
                                <?php
                            }
        ...
        <div class="col-md-12">
            <div class="box box-info" style="padding-top:0;">
                <div class="box-body" style="padding-top:0;">
                    ...
                    <?=form_open_multipart(base_url('admin/footersetting/update'),array('class' => 'form-horizontal')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <button value="2" type="submit" class="btn btn-success pull-left" name="form_footer_general">Update</button>
                        </select>
                        </div>
                    </div>
                    <?=form_close(); ?>
                    ...
                    <?=form_open_multipart(base_url('admin/footersetting/update'),array('class' => 'form-horizontal')); ?>
                        ...
                        <div class="form-group">
                            <?=form_wp_photo('photo',$footer_setting_lang_independent['cta_background'],'photo','Call to Action (CTA) Background',false,'col-sm-4')?>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2"></label>
                            <div class="col-sm-6">
                                <button value="1" type="submit" class="btn btn-success pull-left" name="form_footer_cta_bg">Update</button>
                            </select>
                            </div>
                        </div>
                    <?=form_close(); ?>
