...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?=base_url("admin/footersetting")?>" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
	  ...
	  <?=form_open_multipart(base_url('admin/footersetting/edit/').$footer_setting['id'], array('class' => 'form-horizontal'));?>
