...
<section class="content">
  <div class="row">
    <div class="col-md-12">
       ...
       <?=flash_message()?>
	   <?=form_open(base_url("admin/lang/edit/{$lang['lang_id']}"),array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="lang_short_name" value="<?=$lang['lang_short_name']?>">
							</div>
						</div>
						<div class="form-group">
