...
<section class="content-header">
    ...
    <div class="content-header-right">
        <a href="<?php echo base_url(); ?>admin/pagehome" class="btn btn-primary btn-sm">View All</a>
    </div>
</section>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
       ...
       <?=flash_message()?>
       <?php echo form_open_multipart(base_url().'admin/pagehome/edit/'.$page_home['id'], array('class' => 'form-horizontal'));?>
