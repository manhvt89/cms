...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?=form_open_multipart(base_url().'admin/portfolio/edit/'.$portfolio['id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<?=form_wp_photo('photo',$portfolio['photo'],'photo','Featured Photo',true,'col-sm-4')?>
						</div>
