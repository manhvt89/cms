...
<section class="content-header">
	...
	<div class="content-header-right">
        <a href="<?= base_url('admin/service/add') ?>" class="btn btn-primary mb-3">Thêm Menu</a>
						...
						<tbody>
							...
							foreach ($service as $row) {
								...
								<tr>
									...
									<td style="width:200px;"><img src="<?php echo base_url($row['photo']) ?>" alt="<?php echo $row['name']; ?>" style="width:200px;"></td>
