...
<!--Banner Start-->
<div class="banner-slider" style="background-image: url(<?php echo base_url($setting['banner_event']); ?>)">
    <div class="bg"></div>
    <div class="bannder-table">
        <div class="banner-text">
            <h1><?php echo $page_event['heading']; ?></h1>
        </div>
    </div>
</div>
<!--Banner End-->
                    ...
                    <div class="event-item">
                        <div class="row">
                            <div class="col-xl-3 col-lg-4">
                                <div class="event-photo" style="background-image: url(<?php echo base_url(); ?>uploads/<?php echo $row->photo; ?>)"></div>
                            </div>
