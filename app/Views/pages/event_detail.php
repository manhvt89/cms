...
<!--Banner Start-->
<div class="banner-slider" style="background-image: url(<?php echo base_url($event_detail['banner']); ?>)">
    <div class="bg"></div>
                ...
                <div class="event-detail-content">
                    <div class="event-carousel owl-carousel">
                        <div class="event-photo-item">
                            <img src="<?php echo base_url(); ?>uploads/<?php echo $event_detail['photo']; ?>" alt="Event Photo">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        foreach($event as $row) {
                            ...
                            <div class="sidebar-recent-item">
                                <div class="recent-photo">
                                    <a href="<?php echo base_url(); ?>event/view/<?php echo $row['event_id']; ?>"><img src="<?php echo base_url().'uploads/'.$row['photo']; ?>" alt="Event Photo"></a>
                                </div>
