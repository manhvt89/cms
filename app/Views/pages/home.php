            ...
            <div class="col-lg-6 mt_30">
                <div class="about-content">
                    <div class="headline-left">
                        <h2>
                            <span><?=$page_home['home_welcome_title']; ?></span> <?=$page_home['home_welcome_subtitle']; ?>
                        </h2>
                    </div>
                    <p>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            foreach ($why_choose as $row) {
                ?>
                <div class="col-lg-4">
                    <div class="choose-item flex" style="background-image: url(<?php echo base_url($row['photo']) ?>)">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item effect-item">
                        ...
                        <div class="services-text">
                            ...
                            <div class="button-bn">
                                <a href="<?php echo base_url(); ?>service/view/<?php echo $row['id']; ?>"><?=READ_MORE ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="counterup-area pt_60 pb_90" style="background-image: url(<?=base_url($page_home_lang_independent['counter_photo']) ?>)">
    ...
    <div class="container">
                ...
                <div class="portfolio-menu">
                    <ul id="filtrnav">
                        ...
                        foreach ($portfolio_category as $row) {
                            ?>
                            <li class="filtr" data-filter="<?=$row['category_id']; ?>"><?=$row['category_name']; ?></li>
                            <?php
                        }
                        ?>
                    </ul>
        ...
        <div class="row filtr-container">            
            ...
            foreach ($portfolio as $row) {
                ?>
                <div class="col-lg-4 col-md-6 filtr-item" data-category="<?=$row['category_id']; ?>" data-sort="Menu">
                    <div class="portfolio-group">
                        <div class="portfolio-photo" style="background-image: url(<?=base_url($row['photo']) ?>)">
                            <div class="portfolio-bg"></div>
                            <div class="portfolio-table">
                                <div class="portfolio-icon">
                                    <a href="<?php echo base_url($row['photo']) ?>" class="magnific"><i class="fa fa-search-plus"></i></a>
                                </div>
                            </div>
                        </div>
...
<div class="booking-area pt_60 pb_90" style="background-image: url(<?=base_url($page_home_lang_independent['home_booking_photo']) ?>)">
            ...
            <div class="col-lg-6">
                <div class="booking-gallery">
                    ...
                    <div class="booking-form pt_30">
                        <?= form_open(base_url().'home/send_email',array('class' => '')); ?>
                    ...
                    foreach ($team_members as $row) {
                        ...
                        <div class="team-item">
                            <div class="team-photo">
                                <img src="<?=base_url($row['photo']) ?>" alt="Team Photo">
                            </div>
                            <div class="team-text">
                                <a href="<?=base_url("team-member/{$row['id']}")?>"><?=$row['name']; ?></a>
                                <p><?=$row['designation']; ?></p>
                            </div>
...
<div class="testimonial-area pt_90 pb_90" style="background-image: url(<?=base_url($page_home_lang_independent['home_testimonial_photo']); ?>)">
                    ...
                    foreach ($testimonials as $row) {
                        ...
                        <div class="testimonial-item">
                            <div class="testimonial-photo">
                                <img src="<?=base_url($row['photo']) ?>" alt="Cline Photo">
                            </div>
                ...
                <div class="blog-carousel owl-carousel">                    
                    ...
                    foreach ($all_news_category as $news) {
                        ...
                        <div class="blog-item effect-item">
                            <a href="<?=base_url("news/view/{$_sSlugNews}-{$news['news_id']}")?>" class="image-effect">
                                <div class="blog-image" style="background-image: url(<?=base_url($news['photo']) ?>)"></div>
                            </a>
                            <div class="blog-text">
                                <h3><a href="<?=base_url("news/view/{$_sSlugNews}-{$news['news_id']}") ?>"><?=$news['news_title']; ?></a></h3>
                                <span><i class="fa fa-calendar-o"></i>
                                    <?=format_news_date($news['news_date'])?></span>
                                <p>
                            ...
                            <div class="blog-author">
                                <ul>
                                    <li><a href="<?=base_url("category/{$_sSlugCat}-{$news['category_id']}") ?>"><i class="fa fa-pencil-square-o"></i><?php echo $news['category_name']; ?></a></li>
                                    <li class="blog-button"><a href="<?=base_url("news/view/{$_sSlugNews}-{$news['news_id']}") ?>"><i class="fa fa-long-arrow-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <?php
            ...
            <div class="col-12">
                <div class="brand-carousel owl-carousel">
                    ...
                    foreach($clients as $row) {
                        ...
                        ?>
                        <?php if($row['url']!=''): ?>
                            <div class="brand-item"><a href="<?php echo $row['url']; ?>"><img src="<?php echo base_url($row['photo']); ?>" alt="<?php echo $row['name']; ?>"></a></div>
                        <?php else: ?>
                            <div class="brand-item"><img src="<?php echo base_url($row['photo']); ?>" alt="<?php echo $row['name']; ?>"></div>
                        <?php endif; ?>
                        <?php
                    }
                    ?>
