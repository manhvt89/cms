                            ...
                            <div class="portfolio-photo" style="background-image: url(<?=base_url($row['photo']); ?>)">
                                ...
                                <div class="portfolio-table">
                                    <div class="portfolio-icon">
                                        <a href="<?=base_url($row['photo']); ?>" class="magnific"><i class="fa fa-search-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="portfolio-text">
                                <h3><a href="<?=base_url("portfolio/view/{$_sSlug}-{$row['id']}"); ?>"><?php echo $row['name']; ?></a></h3>
                            </div>
                        </div>
                        <?php
                    }
